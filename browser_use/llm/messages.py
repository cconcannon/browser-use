...
class ImageURL(BaseModel):
	"""Image URL with detail level and media type."""
...
class Function(BaseModel):
	"""Function call with arguments and name."""
...
class ToolCall(BaseModel):
	"""Tool call with ID, function, and type."""
...
class UserMessage(_MessageBase):
	"""User message with content and optional name."""
...
class SystemMessage(_MessageBase):
	"""System message with content and optional name."""
...
class AssistantMessage(_MessageBase):
	"""Assistant message with content, tool calls, and optional name."""
